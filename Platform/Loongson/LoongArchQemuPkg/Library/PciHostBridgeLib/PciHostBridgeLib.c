/** @file
  LoongArch's instance of the PCI Host Bridge Library.
  ...
  )
{
  ...
  IoBase = 0x4000;
  IoSize = 0x10000 - IoBase + 1;
  Mmio32Base = 0x40000000;
  Mmio32Size = 0x40000000;
//  Mmio64Base = 
//  Mmio64Size
  BusMin = 0;
  BusMax = 255;
  ...
  *Count = 1;
  ...
  mRootBridge.Mem.Limit             = Mmio32Base + Mmio32Size;
#if 0
